    ...
    settings: {
      ...
      anthropicAdaptiveScheduler: {
        ...
        tooltips: {
          ...
          capacityGrowthFactor: 'Capacity multiplier applied after enough high-load successes in the current generation.',
          capacityRecoverySamples: 'Successful requests in the current capacity generation required before recovery.',
          capacityRecoveryLoad: 'Minimum effective-capacity utilization required for a success to count toward recovery.',
