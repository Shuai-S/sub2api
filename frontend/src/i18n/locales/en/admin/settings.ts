    ...
    settings: {
      ...
      geminiAdaptiveScheduler: {
        ...
        parameters: {
          ...
          accountFailureThreshold: 'Account failure threshold',
          modelFailureThreshold: 'Model failure threshold',
          capacityProbeLoadThreshold: 'Capacity probe load threshold',
          capacitySuccessThreshold: 'Capacity growth success threshold',
          capacityIncreaseStep: 'Capacity increase step',
          minCapacity: 'Minimum learned capacity',
          ...
          learningWindowSeconds: 'Learning window (seconds)',
          cooldownSeconds: 'Shrink cooldown (seconds)',
          cooldownMaxSeconds: 'Maximum cooldown (seconds)',
          halfOpenProbeLeaseSeconds: 'Half-open probe lease (seconds)',
          successEmaAlpha: 'Success EMA alpha',
          latencyEmaAlpha: 'Latency EMA alpha',
          weightReliability: 'Reliability weight',
        ...
        tooltips: {
          ...
          accountFailureThreshold: 'Consecutive account-wide failures required before opening the account circuit and limiting it to half-open probes.',
          modelFailureThreshold: 'Consecutive failures for the same account and model required before opening the model circuit.',
          ...
          cooldownMaxSeconds: 'Maximum cooldown duration after repeated failures.',
          halfOpenProbeLeaseSeconds: 'Lease duration for an account or model half-open recovery probe.',
