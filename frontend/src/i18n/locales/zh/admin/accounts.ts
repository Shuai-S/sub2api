export default {
    accounts: {
      ...
      openai: {
        ...
        responsesModeDesc:
          '仅对 OpenAI API Key 的文本转发链路生效。自动跟随探测结果，强制模式会覆盖自动探测；按入站协议直转要求上游同时支持 Responses 和 Chat Completions。',
        responsesModeAuto: '自动',
        responsesModeForceResponses: '强制 Responses',
        responsesModeForceChatCompletions: '强制 Chat Completions',
        responsesModeFollowIngress: '按入站协议直转',
        ...
        capabilityFollowIngress: 'Responses / Chat Completions（按入站协议）',
        ...
        responsesStatusFollowIngress: '已按入站协议直转（需同时支持两种端点）',
        planType: '订阅档位（手动覆盖）',
