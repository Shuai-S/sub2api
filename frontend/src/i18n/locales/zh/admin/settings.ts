    ...
    settings: {
      ...
      geminiAdaptiveScheduler: {
        ...
        parameters: {
          ...
          accountFailureThreshold: '账号失败阈值',
          modelFailureThreshold: '模型失败阈值',
          capacityProbeLoadThreshold: '容量探测负载阈值',
          capacitySuccessThreshold: '容量增长成功率阈值',
          capacityIncreaseStep: '容量增长步长',
          minCapacity: '最小学习容量',
          ...
          learningWindowSeconds: '学习窗口（秒）',
          cooldownSeconds: '缩容冷却（秒）',
          cooldownMaxSeconds: '最大冷却（秒）',
          halfOpenProbeLeaseSeconds: '半开探测租约（秒）',
          successEmaAlpha: '成功率 EMA Alpha',
          latencyEmaAlpha: '延迟 EMA Alpha',
          weightReliability: '可靠性权重',
          weightQuota: '配额节奏权重',
        ...
        tooltips: {
          ...
          accountFailureThreshold: '账号级连续失败达到此次数后打开账号熔断，后续请求只允许半开探测。',
          modelFailureThreshold: '同一账号模型级连续失败达到此次数后打开模型熔断，避免该模型持续命中失败账号。',
          ...
          cooldownMaxSeconds: '连续失败时冷却时间允许增长到的最大值。',
          halfOpenProbeLeaseSeconds: '半开探测占用账号或模型探测名额的租约时长。',
