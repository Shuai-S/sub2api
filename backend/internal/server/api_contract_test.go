		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"openai_adaptive_scheduler_capacity_probe_load_threshold": 0.80,
					...
					"openai_adaptive_scheduler_shrink_factor_soft": 0.90,
					...
					"anthropic_adaptive_scheduler_shrink_factor_soft": 0.9,
					...
					"anthropic_adaptive_scheduler_weight_latency": 0.15,
						...
						"gemini_adaptive_scheduler_shrink_factor_soft": 0.9,
