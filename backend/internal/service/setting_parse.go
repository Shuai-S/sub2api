...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyCaptchaLaBindIP:                           "false",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		CaptchaLaBindIP:                        settings[SettingKeyCaptchaLaBindIP] == "true",
		CaptchaLaAppSecretConfigured:           settings[SettingKeyCaptchaLaAppSecret] != "",
	...
	result.CaptchaLaAppSecret = settings[SettingKeyCaptchaLaAppSecret]
	...
	result.AnthropicAdaptiveScheduler = parseAnthropicAdaptiveSchedulerSettings(settings)
	result.GeminiAdaptiveScheduler = parseGeminiAdaptiveSchedulerSettings(settings)
