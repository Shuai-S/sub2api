...
func (r *paymentFulfillmentAffiliateRepoStub) BindInviterWithRegistrationRewards(context.Context, int64, int64, float64, float64) (*AffiliateRegistrationRewardResult, error) {
	panic("unexpected BindInviterWithRegistrationRewards call")
}
