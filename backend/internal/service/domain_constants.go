...
const (
	...
	AffiliateInviterRegistrationRewardDefault = 0.0   // 邀请人注册奖励默认关闭
	AffiliateInviteeRegistrationRewardDefault = 0.0   // 被邀请人注册奖励默认关闭
)
...
const (
	...
	AffiliateLedgerActionRegistrationInviterReward = "registration_inviter_reward"
	AffiliateLedgerActionRegistrationInviteeReward = "registration_invitee_reward"
)
...
const (
	...
	SettingKeyAffiliateInviterRegistrationReward  = "affiliate_inviter_registration_reward" // 邀请人获得的注册奖励
	SettingKeyAffiliateInviteeRegistrationReward  = "affiliate_invitee_registration_reward" // 被邀请人获得并自动转余额的注册奖励
