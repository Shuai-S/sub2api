...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	captchaLaVerifier := repository.NewCaptchaLaVerifier()
	captchaLaService := service.NewCaptchaLaService(settingService, captchaLaVerifier)
